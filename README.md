...
I imported Seaborn to produce neater looking scatter plot graphs [28] Conclusions can be reached using Pairplot as it allows you to compare and observe the data.[29]
